...
frames=sorted(set(range(1,1645,12))|{1,13,35,47,265,289,505,745,865,1105,1321,1345,1369,1601,1613,1632,1644})
...
for f in frames:
    ...
    if q['tilt_deg']>1e-6 and q['lift_mm']<34.99:invariants.append([f,'tilt below rim-clearance height'])
...
analytic=[]
for j in range(121):
    a=j/10;low,high=shaft_heights(35,a);t=math.radians(a)
